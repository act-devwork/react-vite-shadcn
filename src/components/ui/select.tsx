...
function SelectTrigger({
  ...
  const canClear = clearable && Boolean(onClear) && !props.disabled;
  const trigger = (
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        className="cursor-pointer text-muted-foreground hover:bg-accent hover:text-accent-foreground absolute top-1/2 right-7 flex size-6 rounded-full -translate-y-1/2 items-center justify-center outline-none focus-visible:ring-2 focus-visible:ring-ring"
        onClick={onClear}
        type="button"
      >
